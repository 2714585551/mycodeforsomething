 ...
 * 
 */
package com.staff.system.core.controller;
...
import com.staff.system.core.exception.BusinessException;
import com.staff.system.core.vo.ResponseMessage;
...
public class GlobalExceptionHandler {
	...
	public ModelAndView handRuntimeException(HttpServletRequest request, Exception ex) {
		LOG.info("RuntimeException " + ex.getMessage());
		ModelAndView mv = new ModelAndView();
		mv.addObject("message", ex.getMessage());
		mv.setViewName("Runtime_error");
		return mv;
	}
