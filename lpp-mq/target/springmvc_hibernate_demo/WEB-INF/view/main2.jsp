...
<body>
	...
	<div id="layout1" class="mini-layout"
		...
		<div class="header" region="north" height="70" showSplit="false"
			showHeader="false">
			<h1
				style="margin: 0; padding: 15px; cursor: default; font-family: 微软雅黑, 黑体, 宋体;">XXX应用管理系统
				V2</h1>
			<div style="position: absolute; top: 18px; right: 10px;">
				<a class="mini-button mini-button-iconTop" iconCls="icon-add"
					onclick="onQuickClick" plain="true">快捷</a> <a
					class="mini-button mini-button-iconTop" iconCls="icon-edit"
					onclick="onClick" plain="true">首页</a> <a
					class="mini-button mini-button-iconTop" iconCls="icon-date"
					onclick="onClick" plain="true">消息</a> <a
					class="mini-button mini-button-iconTop" iconCls="icon-edit"
					onclick="onClick" plain="true">设置</a> <a
		...
		<div title="center" region="center" style="border: 0;"
			...
			<div class="mini-splitter" style="width: 100%; height: 100%;"
				...
				<div size="180" maxSize="250" minSize="100"
					...
					<!--OutlookTree-->
					<div id="leftTree" class="mini-outlooktree" url="loadMenu"
